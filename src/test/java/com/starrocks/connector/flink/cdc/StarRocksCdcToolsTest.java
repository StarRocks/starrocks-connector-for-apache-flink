...
class StarRocksCdcToolsTest {
    public static void main(String[] args) throws Exception{
        ...
        String database = "test_cdc";
        String tablePrefix = "";
        String tableSuffix = "";
        Map<String,String> mysqlConfig = new HashMap<>();
        mysqlConfig.put("database-name","test_cdc");
        ...
        sinkConfig.put("load-url","127.0.0.1:8030");
        ...
        databaseSync.build();
        env.execute(String.format("MySQL-StarRocks Database Sync: %s", database));
    }
}