...
public class StarRocksCatalogTest extends StarRocksITTestBase {
    ...
    public void testDatabase() throws Exception {
        StarRocksCatalog catalog = createCatalog("test_db_catalog");
    ...
    public void testListAndExistTable() throws Exception {
        StarRocksCatalog catalog = createCatalog("test_table_catalog");
    ...
    public void testCreateTable() throws Exception {
        ...
        StarRocksCatalog catalog = createCatalog("test_table_catalog", tableConf);
    ...
    private StarRocksCatalog createCatalog(String catalogName) {
        return createCatalog(catalogName, new Configuration());
    }

    private StarRocksCatalog createCatalog(String catalogName, Configuration tableConf) {
