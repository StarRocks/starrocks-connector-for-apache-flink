...
public class StarRocksSinkManager implements Serializable {
    ...
    public final synchronized void writeRecords(String database, String table, String... records) throws IOException {
        ...
        try {
            ...
            StarRocksSinkBufferEntity bufferEntity = bufferMap.computeIfAbsent(bufferKey, k -> new StarRocksSinkBufferEntity(database, table));
    ...
    private void waitAsyncFlushingDone() throws InterruptedException {
        ...
        offer(new StarRocksSinkBufferEntity(null, null));
        offer(new StarRocksSinkBufferEntity(null, null));
        checkFlushException();
    }
    ...
    private void offerEOF() {
        try {
            offer(new StarRocksSinkBufferEntity(null, null).asEOF());
        } catch (Exception e) {
