...
| sink.socket.timeout-ms            | No           | -1                | Supported sink 1.2.10. The time duration for which the HTTP client waits for data. Unit: ms. The default value `-1` means there is no timeout.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| sink.properties.compression       | No           | NONE              | The compression algorithm used for Stream Load. Currently, compression is only supported for the JSON format. Valid values: lz4_frame.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
