...
public class StarRocksDynamicTableSink implements DynamicTableSink {
    ...
    private transient ResolvedSchema flinkSchema;
    private StarRocksSinkOptions sinkOptions;

    public StarRocksDynamicTableSink(StarRocksSinkOptions sinkOptions, ResolvedSchema schema) {
    ...
    public SinkRuntimeProvider getSinkRuntimeProvider(Context context) {
        final TypeInformation<RowData> rowDataTypeInfo = context.createTypeInformation(flinkSchema.toPhysicalRowDataType());
