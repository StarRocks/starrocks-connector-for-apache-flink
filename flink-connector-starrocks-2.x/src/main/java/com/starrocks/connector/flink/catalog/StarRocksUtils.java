...
public class StarRocksUtils {
    ...
    public static StarRocksTable toStarRocksTable(
        ...
        if (flinkTable instanceof ResolvedCatalogBaseTable) {
            flinkSchema = ((ResolvedCatalogBaseTable<?>) flinkTable).getResolvedSchema();
        } else {
            throw new CatalogException(
                    String.format("Catalog %s received unresolved table %s. Expected ResolvedCatalogBaseTable.",
