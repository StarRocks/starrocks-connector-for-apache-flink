...
public class StarRocksDynamicTableSourceITTest extends StarRocksSourceBaseTest {
    ...
    public void testDataStream() throws Exception {
        ...
        List<RowData> dList = env.fromSource(StarRocksSource.source(TABLE_SCHEMA, OPTIONS_WITH_COLUMN_IS_COUNT), WatermarkStrategy.noWatermarks(), "StarRocks Source").setParallelism(5).executeAndCollect(50);
