...
public class StarRocksDynamicTableSourceTest extends StarRocksSourceBaseTest {
    ...
    public void testApplyProjection() {
        dynamicTableSource.applyProjection(PROJECTION_ARRAY, DataTypes.ROW());
        ...
        dynamicTableSource.applyProjection(PROJECTION_ARRAY_NULL, DataTypes.ROW());
    ...
    public void testFilter() {
        ...
        ResolvedExpression c9CharLength = CallExpression.permanent(BuiltInFunctionDefinitions.CHAR_LENGTH, Collections.singletonList(c9Ref), DataTypes.INT());
        ...
        dynamicTableSource.applyFilters(Arrays.asList(CallExpression.permanent(BuiltInFunctionDefinitions.OR, Arrays.asList(c1Exp, c3Exp), DataTypes.BOOLEAN())));
        filter = pushDownHolder.getFilter();
