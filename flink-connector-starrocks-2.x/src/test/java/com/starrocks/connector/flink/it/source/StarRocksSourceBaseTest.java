...
public abstract class StarRocksSourceBaseTest {
    ...
    protected ResolvedSchema TABLE_SCHEMA;
    protected ResolvedSchema TABLE_SCHEMA_NOT_NULL;
    ...
    public void initializeTableSchema() {
        TABLE_SCHEMA = ResolvedSchema.physical(
            new String[]{"date_1", "datetime_1", "char_1", "varchar_1", "boolean_1",
                "tinyint_1", "smallint_1", "int_1", "bigint_1", "largeint_1",
    ...
    public void initializeTableSchemaNotNull() {
        TABLE_SCHEMA_NOT_NULL = ResolvedSchema.physical(
            new String[]{"date_1", "datetime_1", "char_1", "varchar_1", "boolean_1",
                "tinyint_1", "smallint_1", "int_1", "bigint_1", "largeint_1",
                "float_1", "double_1", "decimal_1"},
            new DataType[]{
                ...
                DataTypes.DECIMAL(27, 9).notNull()
            });
    }
    ...
    protected String getQuerySql() {
        return String.format("select %s from `test`.`test_source`",
                TABLE_SCHEMA.getColumnNames().stream().map(col -> "`" + col + "`")
