...
/** Serializer for String records (used by the CDC/DataStream String-sink path). */
public class StringSerializationSchema implements RecordSerializationSchema<String> {
    ...
    public StringSerializationSchema(String databaseName, String tableName) {
