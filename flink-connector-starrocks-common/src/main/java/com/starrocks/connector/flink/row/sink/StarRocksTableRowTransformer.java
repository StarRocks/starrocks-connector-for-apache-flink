...
public class StarRocksTableRowTransformer implements StarRocksIRowTransformer<RowData> {
    ...
    @Override
    public void setTableSchema(ResolvedSchema ts) {
        this.columnNames = ts.getColumnNames().toArray(new String[0]);
        this.columnDataTypes = ts.getColumnDataTypes().toArray(new DataType[0]);
    }
