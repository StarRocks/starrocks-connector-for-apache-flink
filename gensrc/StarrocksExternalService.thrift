...
//   https://github.com/StarRocks/starrocks/tree/main/gensrc/thrift/StarrocksExternalService.thrift
...
struct TScanNextBatchParams {
  ...
  1: optional string context_id    // starrocks olap engine context id
  2: optional i64 offset            // starrocks should check the offset to prevent duplicate rpc calls
}
